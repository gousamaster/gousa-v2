      ...
      <div className="mb-4 rounded-xl border border-blue-200 bg-gradient-to-r from-blue-50 via-background to-background p-5 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">Tu agenda operativa compartida: entrevistas, simulacros, asesorías, recordatorios, cumpleaños y pendientes próximos.</p>
          </div>
        </div>
      </div>
...
export default async function DashboardPage() {
  ...
  return <div className="flex-1"><DashboardTime/></div>;
}

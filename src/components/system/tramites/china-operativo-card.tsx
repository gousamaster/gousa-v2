...
export function ChinaOperativoCard({tramiteId}:{tramiteId:string}){
  ...
  return <div className="rounded-xl border border-red-200 bg-red-50/40 p-4 space-y-5">
    ...
    <div className="rounded-lg border bg-background/80 p-3 text-sm"><p className="font-medium">Datos personales y familiares</p><p className="mt-1 text-xs text-muted-foreground">Los datos generales del cliente y sus hijos se administran en la ficha única del cliente. China reutiliza esa misma información sin duplicarla.</p></div>

...
async function leerRespuesta(r:Response){
  ...
  if(!text)return {} as {error?:string;documentos?:Documento[]};
  try{return JSON.parse(text) as {error?:string;documentos?:Documento[]}}

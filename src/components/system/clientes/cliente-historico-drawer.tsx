...
export function ClienteHistoricoDrawer({ open, onOpenChange, regiones, onSuccess }: {
  ...
  return <Sheet open={open} onOpenChange={onOpenChange}>
    <SheetContent className="w-full overflow-y-auto sm:max-w-xl">
      ...
      <div className="mb-5 rounded-md border bg-muted/40 p-3 text-sm text-muted-foreground">Este registro no reconstruye pagos, DS-160 ni citas antiguas. Desde su nueva atención, los movimientos futuros sí quedan registrados normalmente en NEXUS.</div>
